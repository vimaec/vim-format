...
int test_object_model(const std::string &repo_path)
{
    const std::vector<TestCase> test_cases =
    {
        TestCase(normalize_path(repo_path + "data\\Wolford_Residence.r2023.om_v4.4.0.vim"), 4464, { -1ll, 1222722ll, 32440ll, 118390ll, 174750ll, 18438ll, 355500ll, 185913ll, 9946ll, 182664ll }),
        TestCase(normalize_path(repo_path + "data\\Wolford_Residence.r2023.om_v5.0.0.vim"), 4473, { -1ll, 1222722ll, 75912ll, -1ll, 32440ll, 118390ll, 22793ll, 22794ll, 22795ll, 22796ll })
    };
