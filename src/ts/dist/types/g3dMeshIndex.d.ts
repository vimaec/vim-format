 ...
 */
export declare class MeshIndexAttributes {
 ...
 */
export declare class G3dMeshIndex {
    rawG3d: AbstractG3d;
    ...
    private createMap;
    static createFromAbstract(g3d: AbstractG3d): G3dMeshIndex;
    static createFromPath(path: string): Promise<G3dMeshIndex>;
