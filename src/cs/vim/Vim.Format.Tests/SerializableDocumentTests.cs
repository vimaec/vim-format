...
public static class SerializableDocumentTests
{
    ...
    //        var mesh = scene.MeshesOld[i].ReverseWindingOrder() as VimMesh;
    ...
    //[Test]
    //public static void FromG3d_Equals_ToVimMesh()
    //{
    //    var path = VimFormatRepoPaths.GetLatestWolfordResidenceVim();
    //    var scene = VimScene.LoadVim(path);
    //    var mesh = scene.Document.Geometry as VimMesh;
    ...
    //private static void Consume(VimMesh mesh)
    //{
    //    mesh.Indices.Sum();
