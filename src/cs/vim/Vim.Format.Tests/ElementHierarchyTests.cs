...
[TestFixture]
public static class ElementHierarchyTests
{
    [Test]
    public static void TestFlattenElementHierarchy()
    {
        ...
        var dummyA = new ElementGeometryInfo(0);
        var dummyB = new ElementGeometryInfo(1);
        var dummyC = new ElementGeometryInfo(2);
        var dummyD = new ElementGeometryInfo(3);
        dummyD.NodeAndGeometryIndices.Add((33, 33));
        var dummyE = new ElementGeometryInfo(4);
        dummyE.NodeAndGeometryIndices.Add((44, 44));

        var dummyMap = new ElementGeometryMap(new[]
        {
            dummyA,
            dummyB,
            dummyC,
        ...
        var flattened = ElementHierarchyService.FlattenElementHierarchy(
            treeRoot,
            false,
            dummyMap)
    ...
    [TestCase(true)]
    [TestCase(false)]
    public static void TestElementHierarchy(bool isElementAndDescendantPrimaryKey)
    {
        var ctx = new CallerTestContext();
        ...
        var g3d = Serializer.Deserialize(vimFilePath, new() { SchemaOnly = true, SkipAssets = true }).Geometry;
        var map = new ElementGeometryMap(fileInfo, g3d);
        var service = new ElementHierarchyService(fileInfo, map, isElementAndDescendantPrimaryKey);
