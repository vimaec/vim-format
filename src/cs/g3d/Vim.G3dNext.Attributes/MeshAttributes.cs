...
namespace Vim.G3dNext.Attributes
{
    ...
    [AttributeDescriptor("Mesh", "g3d:submesh:indexoffset:0:int32:1", AttributeType.Index, IndexInto = typeof(IndicesAttribute))]
    public partial class MeshSubmeshIndexOffsetsAttribute { }

    [AttributeDescriptor("Mesh", "g3d:submesh:vertexoffset:0:int32:1", AttributeType.Index, IndexInto = typeof(IndicesAttribute))]
    public partial class MeshSubmeshVertexOffsetsAttribute { }

    [AttributeDescriptor("Mesh", "g3d:submesh:material:0:int32:1", AttributeType.Index, IndexInto = typeof(MaterialColorsAttribute))]
    ...
    [AttributeDescriptor("Mesh", "g3d:corner:index:0:int32:1", AttributeType.Index, IndexInto = typeof(PositionsAttribute))]
