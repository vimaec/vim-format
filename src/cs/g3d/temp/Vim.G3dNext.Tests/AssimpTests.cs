...
using System.IO;
using System.Linq;
using Vim.G3dNext.AssimpWrapper;
using Vim.G3dNext.Attributes;
using Vim.Math3d;

using NextG3d = Vim.G3dNext.G3DNext<Vim.G3dNext.Attributes.VimAttributeCollection>;
...
namespace Vim.G3dNext.Tests
{
    ...
    public static class AssimpTests
    {
        ...
        public static void ValidateSameG3D(NextG3d g1, NextG3d g2)
        {
        ...
        public static void OpenAndConvertAssimpFiles()
        {
            ...
            foreach (var f in files)
            {
                ...
                try
                {
                    NextG3d localG3d = null;

                    (f.MemoryConsumptionG3d, f.MSecToOpenG3d) =
                        TestUtils.GetMemoryConsumptionAndMSecElapsed(() =>
                            NextG3d.TryRead(f.G3DFile.FullName, out localG3d));
        ...
        public static NextG3d LoadAssimpFile(string filePath)
        {
